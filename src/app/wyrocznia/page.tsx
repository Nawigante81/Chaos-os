...
import { BrainCircuit, Sparkles, Loader2, RotateCcw } from 'lucide-react';
...
export default function WyroczniaPage() {
  ...
  return (
    <main className="min-h-[100svh] bg-violet-950 flex flex-col items-center justify-center p-4 xs:p-5 sm:p-6 relative overflow-hidden">
      {/* Mystic Background */}
